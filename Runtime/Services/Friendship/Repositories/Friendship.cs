...
namespace DynamicPixels.GameService.Services.Friendship.Repositories
{
    public class FriendshipRepository : IFriendshipRepository
    {
        ...
        public async Task<RowListResponse<Models.Friendship>> GetMyFriends<T>(T input) where T : GetMyFriendsParams
        {
            ...
            {
                return JsonConvert.DeserializeObject<RowListResponse<Models.Friendship>>(body);
            }
            else
            {
        ...
        public async Task<RowListResponse<Models.Friendship>> GetMyFriendshipRequests<T>(T input) where T : GetMyFriendshipRequestsParams
        {
        ...
        public async Task<RowResponse<Models.Friendship>> RequestFriendship<T>(T input) where T : RequestFriendshipParams
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<RowResponse<Models.Friendship>>(body);
            }
            else
            {
                // Deserialize the error response
        ...
        public async Task<RowResponse<Models.Friendship>> AcceptRequest<T>(T input) where T : AcceptRequestParams
        {
        ...
        public async Task<RowResponse<Models.Friendship>> RejectRequest<T>(T input) where T : RejectRequestParams
        {
