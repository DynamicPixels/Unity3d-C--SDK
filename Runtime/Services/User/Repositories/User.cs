...
namespace DynamicPixels.GameService.Services.User.Repositories
{
    ...
    {
        public async Task<RowListResponse<Models.User>> Find<T>(T input) where T : FindUserParams
        {
            ...
            {
                return JsonConvert.DeserializeObject<RowListResponse<Models.User>>(body);
            }
            else
            {
        ...
        public async Task<RowResponse<Models.User>> FindUserById<T>(T input) where T : FindUserByIdParams
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<RowResponse<Models.User>>(body);
            }
            else
            {
                // Deserialize the error response
        ...
        public async Task<RowResponse<Models.User>> EditCurrentUser<T>(T input) where T : EditCurrentUserParams
        {
