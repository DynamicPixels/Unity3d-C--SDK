...
namespace DynamicPixels.GameService.Services.Leaderboard.Repositories
{
    public class LeaderboardRepository : ILeaderboardRepository
    {
        ...
        public async Task<RowListResponse<Models.Leaderboard>> GetLeaderBoards<T>(T input) where T : GetLeaderboardsParams
        {
            ...
            {
                return JsonConvert.DeserializeObject<RowListResponse<Models.Leaderboard>>(body);
            }
            else
            {
