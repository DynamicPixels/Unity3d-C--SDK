...
namespace GameService.Client.Sdk.Repositories.Services.User
{
    ...
    {
        public async Task<RowListResponse<Sdk.Services.Services.User.User>> Find<T>(T input) where T : FindUserParams
        {
            ...
            {
                return JsonConvert.DeserializeObject<RowListResponse<Sdk.Services.Services.User.User>>(body);
            }
            else
            {
        ...
        public async Task<RowResponse<Sdk.Services.Services.User.User>> FindUserById<T>(T input) where T : FindUserByIdParams
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<RowResponse<Sdk.Services.Services.User.User>>(body);
            }
            else
            {
                // Deserialize the error response
        ...
        public async Task<RowResponse<Sdk.Services.Services.User.User>> EditCurrentUser<T>(T input) where T : EditCurrentUserParams
        {
