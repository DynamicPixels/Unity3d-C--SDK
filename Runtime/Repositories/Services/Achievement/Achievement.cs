...
namespace GameService.Client.Sdk.Repositories.Services.Achievement
{
    public class AchievementRepository : IAchievementRepository
    {
        ...
        public async Task<RowListResponse<Sdk.Services.Services.Achievement.Achievement>> GetAchievements<T>(T input) where T : GetAchievementParams
        {
            ...
            {
                return JsonConvert.DeserializeObject<RowListResponse<Sdk.Services.Services.Achievement.Achievement>>(body);
            }
            else
            {
