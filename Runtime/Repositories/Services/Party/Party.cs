...
namespace GameService.Client.Sdk.Repositories.Services.Party
{
    public class PartyRepository : IPartyRepository
    {
        ...
        public async Task<RowListResponse<Sdk.Services.Services.Party.Party>> GetParties<T>(T input) where T : GetPartiesParams
        {
            ...
            {
                return JsonConvert.DeserializeObject<RowListResponse<Sdk.Services.Services.Party.Party>>(body);
            }
            else
            {
        ...
        public async Task<RowResponse<Sdk.Services.Services.Party.Party>> CreateParty<T>(T input) where T : CreatePartyParams
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<RowResponse<Sdk.Services.Services.Party.Party>>(body);
            }
            else
            {
                // Deserialize the error response
        ...
        public async Task<RowListResponse<Sdk.Services.Services.Party.Party>> GetSubscribedParties<T>(T input) where T : GetSubscribedPartiesParams
        {
        ...
        public async Task<RowResponse<Sdk.Services.Services.Party.Party>> GetPartyById<T>(T input) where T : GetPartyByIdParams
        {
        ...
        public async Task<RowResponse<Sdk.Services.Services.Party.Party>> EditParty<T>(T input) where T : EditPartyParams
        {
